...
export default function About({ username, loggedIn, setLoggedIn, totalPrice,
  hasPurchased}) {
  return (
    <div className="App full-height">
      <Container>
        ...
        <Row>
          <Col>
            <Figure>
              ...
              <Figure.Caption className="justify text-white">
                ...
                Discover a vast array of caps, from sporty snapbacks to stylish
                fitted hats, all designed to add flair to your everyday look.
                Whether you’re seeking bold colors or classic designs, Cap Haven
                has the perfect cap for every personality. Top off your style
                with us!
              </Figure.Caption>
            </Figure>
          </Col>
          ...
          <Col>
            <Figure>
              <Figure.Image width={400} alt="Inside Store" src={store_inside} />
              <Figure.Caption className="text-white">
        ...
        <Row>
          <div className="container">
            ...
            <p>
              <b>Address:</b> 9 Queensway, Knutsford, Cheshire, WA16 0NJ, United
              Kingdom
            </p>
            <p>
            ...
            <p>
              ...
              <a href="mailto:jackjohn77@msn.com" style={{ marginLeft: "0px" }}>
                Here
              </a>
            </p>
          </div>
