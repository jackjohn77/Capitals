      ...
      <Modal show={show} onHide={handleClose} centered>
        ...
        <Modal.Body>
          <ul>
            ...
            <br />
            <li>
              <input type="checkbox" /> Ticking the checkbox will complete the
              task and toggle to pending if clicked again. When complete this
              will also stop any further editing.
            </li>
          </ul>
        </Modal.Body>
        <Modal.Footer>
